...
export type AvailableBikesQueryVariables = Exact<{
  id: Scalars['String']['input'];
}>;


export type AvailableBikesQuery = { __typename?: 'QueryType', bikeRentalStation?: { __typename?: 'BikeRentalStation', bikesAvailable?: number | null } | null };

export type RouteQueryVariables = Exact<{ [key: string]: never; }>;


export type RouteQuery = { __typename?: 'QueryType', bikeRentalStations?: Array<{ __typename?: 'BikeRentalStation', name: string, stationId?: string | null } | null> | null };


export const AvailableBikesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AvailableBikes"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bikeRentalStation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bikesAvailable"}}]}}]}}]} as unknown as DocumentNode<AvailableBikesQuery, AvailableBikesQueryVariables>;
export const RouteDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"route"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bikeRentalStations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"stationId"}}]}}]}}]} as unknown as DocumentNode<RouteQuery, RouteQueryVariables>;